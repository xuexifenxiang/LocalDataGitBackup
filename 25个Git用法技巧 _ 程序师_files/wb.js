    ...
    var sina_share_count = function (e) { 
            var k = "http://api.weibo.com/2/short_url/shorten.json";
            var m = "https://api.weibo.com/2/short_url/share/counts.json";
            ...
            g({
                ...
                success: function (n) {
                    ...
                    var shorten_url = encodeURIComponent(n.data.urls[0].url_short); 
    ...
    var c = function (o) {
                ...
                if(o.data.urls[0].share_counts > shares_wb) {
                      var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true;
                      ga.src = 'http://aqee.net/misc/shares/touch.php';
